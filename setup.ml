...
(* OASIS_START *)
(* DO NOT EDIT (digest: 694e783825271c67a5d7768b125eebf8) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ojquery-api", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ojquery-api", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Library
                 ({
                      ...
                      },
                   {
                      lib_modules = ["Ojquery"];
                      lib_pack = false;
                      lib_internal_modules = ["Javascript"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Ojquery";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ºý\025+ë\020ô\135\024\149Ù\025[+ï\137";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
