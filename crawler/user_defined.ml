let goji_types = [
("Number/String", To_goji.Unknown "Number/String");
("XMLDocument", To_goji.Unknown "XMLDocument");
...
("", To_goji.Unknown "");
("Element", To_goji.Unknown "Element");
("jQuery object", To_goji.Unknown "jQuery object");
("htmlString", To_goji.Unknown "htmlString");
("Elements", To_goji.Unknown "Elements");
("Function", To_goji.Unknown "Function");
("String", To_goji.Unknown "String");
("Selector", To_goji.Unknown "Selector");
("jQuery", To_goji.Unknown "jQuery");
("", To_goji.Unknown "")]
